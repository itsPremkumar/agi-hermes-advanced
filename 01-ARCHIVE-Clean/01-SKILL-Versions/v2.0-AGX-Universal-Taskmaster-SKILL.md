...
`OBJECTIVE â†’ SPECIFICATION â†’ RECON â†’ RESEARCH â†’ PLAN â†’ HYPOTHESES â†’ VERIFY â†’ EXECUTE â†’ TEST â†’ CRITIQUE â†’ REPAIR â†’ EVOLVE â†’ VALIDATE â†’ DELIVER â†’ LEARN`
...
`CRITIC FAILURE â†’ REVISE, RESEARCH, OR DISCARD`
...
`inspect â†’ change one bounded unit â†’ test â†’ record â†’ next unit`
...
### Pass A â€” Correctness
Make the solution valid and functional.

### Pass B â€” Completeness
...
HYPOTHESIZING
  â†“
CRITIC_GATE
  â”œâ”€â”€ REJECT â†’ RESEARCH / REPLAN
  â””â”€â”€ PASS
        â†“
      EXECUTING
        â†“
      TESTING
        â”œâ”€â”€ FAIL â†’ RECOVERY
        â”‚            â†“
        â”‚          REPLAN
        â””â”€â”€ PASS
              â†“
          EVALUATING
              â†“
          EVOLVING
              â”œâ”€â”€ IMPROVE â†’ NEXT ROUND
              â”œâ”€â”€ STAGNATE â†’ STRATEGY CHANGE
              â””â”€â”€ CONVERGED
                    â†“
                 FINAL_AUDIT
                    â†“
...
`AUTONOMOUS â†’ EVIDENCE-BACKED â†’ EXECUTING â†’ SELF-CORRECTING â†’ EVOLUTIONARY â†’ VERIFIED â†’ AUDITABLE`
